...
const Tonightpass: React.FC = () => {
  return (
    <div className="flex flex-col items-center h-auto min-h-full bg-black pt-16 pb-8 md:px-8">
      ...
      <h2 className="text-white font-semibold text-center mt-8 text-4xl">
        Tonight Pass, <br /> la billetterie 2.0
      </h2>
      <p className="text-white text-center mt-8">
        Réservez votre entrée, entrez rapidement, <br />
        restez en contact avec les gens.
      </p>
      <strong className="text-white text-center mt-8">
