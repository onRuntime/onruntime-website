---
title: 安装
description: 安装并配置 @onruntime/translations
---
## 安装
...
在你的项目中创建一个 `locales` 目录，并为每种语言创建翻译文件：
...
<Callout type="info" title="Next.js 应用路由">
  对于带有应用路由的 Next.js，请查看 [Next.js 使用](/docs/translations/nextjs) 指南，获取推荐的设置。
</Callout>
