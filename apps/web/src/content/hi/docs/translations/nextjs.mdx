---
title: नेक्स्ट.जेएस का उपयोग
description: Next.js ऐप राउ्टर के साथ @onruntime/translations का उपयोग करना
---
## ऐप राउटर के लिए सेटअप

### 1. प्रोवाइडर को कॉन्फ़िगर करें

अनुवाद सेट करने के लिए एक प्रोवाइडर्स फ़ाइल बनाएं:
...
अपने रूट लेआउट में प्रोवाइडर का उपयोग करें:
...
<Callout type="warning" title="सर्वर बनाम क्लाइंट">
  सर्वर कॉम्पोनेंट्स में `getTranslation` और क्लाइंट कॉम्पोनेंट्स में `useTranslation` का उपयोग करें।
</Callout>
...
लोकेल डिटेक्शन को संभालने के लिए मिडलवेयर सेट करें:
...
export function middleware(request: NextRequest) {
  ...
  // चैक करें कि pathname में लोकेल है
  ...
  // डिफ़ॉल्ट लोकेल पर रीडायरेक्ट करें
...
सभी लोकेलों के लिए स्टैटिक पृष्ठ उत्पन्न करें:
...
`Link` कॉम्पोनेंट अपने आप लोकेल प्रीफिक्सिंग को संभालता है।
