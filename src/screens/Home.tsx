        ...
        <MainContainer>
            ...
            <Container>
                <Featured>
                    ...
                    <FeaturedButton href={ROUTES.ABOUT} as={Link} outline>{t("home.featured.btn")}</FeaturedButton>
                </Featured>
                <About>
                    <AboutCol>
                        <AboutImage src={"https://picsum.photos/seed/picsum/1920/1080"} width={1920} height={1080} alt="" />
                    </AboutCol>
                    <AboutCol>
                        <AboutTitle>{t("home.about.title")}</AboutTitle>
                        <AboutDescription>{t("home.about.desc")}</AboutDescription>
                        <AboutButton href={ROUTES.ABOUT} as={Link}>{t("home.about.btn")}</AboutButton>
                    </AboutCol>
                </About>
                <Projects>
