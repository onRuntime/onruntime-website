...
Configure o middleware para lidar com a detecção de localização:
...
export function middleware(request: NextRequest) {
  ...
  // Verifique se o pathname tem uma localização
  ...
  // Redirecionar para a localização padrão
...
Gere páginas estáticas para todas as localidades:
...
O componente `Link` lida automaticamente com a prefixação de localidade.
