...
>
  ...
  {/* Ombre portée */}
  <rect x="22" y="32" width="356" height="236" rx="8" ry="8" fill="#000" opacity="0.15" />

  {/* Bordure principale */}
  <rect x="20" y="30" width="360" height="240" rx="8" ry="8" fill="#2a2a2a" />

  {/* Écran intérieur avec ombre douce */}
  <g>
    <rect x="25" y="35" width="350" height="230" rx="6" ry="6" fill="#3d3d3d" stroke="#111111" stroke-width="3"/>
    <rect x="25" y="35" width="350" height="230" rx="6" ry="6" fill="url(#innerShadow)" />
  </g>

  {/* Encoche en haut */}
  <rect x="180" y="30" width="40" height="12" rx="6" ry="6" fill="#2a2a2a"/>

  {/* Caméra simple */}
  <circle cx="200" cy="36" r="2" fill="#555" />
</svg>
       </div>
      </div>
    </header>
