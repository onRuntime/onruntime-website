...
const DatabaseServicePage = () => {
  return (
    <ServiceLayout
      ...
      heroImage="/static/images/services/back-end/bases-de-données/base-donnee-hero.jpg"
    >
      ...
      <FeatureSection
        ...
        image="/static/images/services/back-end/bases-de-données/excellence-base-donnee.jpg"
      />
