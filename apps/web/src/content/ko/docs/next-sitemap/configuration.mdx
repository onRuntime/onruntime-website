...
<Callout type="info" title="대형 사이트">
  Google은 사이트맵을 50MB와 50,000 URLs 미만으로 유지하는 것을 권장해. 더 큰 사이트의 경우 분할 사이트맵을 사용해.
</Callout>
