...
Claude Code vai analisar suas alterações e criar um commit seguindo a convenção gitmoji.

<Callout type="info" title="Comando do Plugin">
  O comando `/commit` busca automaticamente seu status git e diferenças para gerar a mensagem de commit apropriada.
</Callout>
...
- Use o modo imperativo ("add" e não "added")
